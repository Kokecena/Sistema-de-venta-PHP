...
<head>
    ...
    <title>Sistema de ventas septimo</title>
        ...
        box-shadow mb-3">
            <div class="container>"
                <a class="navbar-brand" >
                    <img src="<?php echo URL.RQ ?>images/icons/luna.png" class="mx-auto w-25 imglogo">SalesSystem
                </a>
                ...
                <div class="navbar-collapse collapse d-sm-inline-flex flex-sm-row-reverse">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link text-dark" tittle="Manage">Hello</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark" tittle="Manage">Logout</a>
                        </li>
                        <li class="nav-item">
